// Verification script to ensure the implementation matches the paper's specifications
...
import {
  ...
  cosineSimilarity,
  aggregateRanks
} from './src/lib/triageAlgorithms.ts';
...
const specialists = [
  { id: 'S1', expertise: 92, availability: 80, successRate: 88, resourceAccess: 90, workload: 6 },
  { id: 'S2', expertise: 89, availability: 70, successRate: 90, resourceAccess: 75, workload: 4 },
  { id: 'S3', expertise: 95, availability: 65, successRate: 91, resourceAccess: 85, workload: 9 },
  { id: 'S4', expertise: 80, availability: 90, successRate: 82, resourceAccess: 70, workload: 3 },
  { id: 'S5', expertise: 88, availability: 85, successRate: 87, resourceAccess: 80, workload: 5 }
];
